...
class OrderAddress
{
    ...
    #[ORM\Column(type: "string", length: self::STREET_MAX_LENGTH)]
    private string $street;

    #[ORM\Column(type: "string", length: self::CITY_MAX_LENGTH)]
    private string $city;

    #[ORM\Column(type: "string", length: self::POSTAL_CODE_MAX_LENGTH)]
    private string $postalCode;

    #[ORM\Column(type: "string", length: self::COUNTRY_CODE_MAX_LENGTH)]
