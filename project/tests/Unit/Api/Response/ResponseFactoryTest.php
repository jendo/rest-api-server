...
class ResponseFactoryTest extends TestCase
{
     ...
     */
    public static function provideValidErrorData(): array
    {
        return [
            'data is string (single error message)' => [
            ...
            'data is associative array with key `message`' => [
            ...
            'data is associative array with key `message` and some additional key' => [
                'data' => [
                    'property' => 'firstName',
            ...
            'data is array of errors (each error is associative array)' => [
                'data' => [
                    [
                        'property' => 'firstName',
                        ResponseFactory::DATA_FIELD_MESSAGE => 'This value should not be blank.',
     ...
     * @return array<string, mixed>
     */
    public static function provideInvalidErrorData(): array
    {
        return [
            'data is empty array' => [
                'data' => [],
            ...
            'data is string with only whitespace' => [
                'data' => '  ',
                'expectedExceptionMessage' => 'Response must contain some data.',
            ],
            'data is associative array without mandatory `message` key' => [
                'data' => [
                    'property' => 'firstName',
                ],
                'expectedExceptionMessage' => 'Each error must contain a `message` field.',
            ],
            'data is array of errors - at least one error without mandatory `message` key' => [
                'data' => [
                    [
                        'property' => 'firstName',
                    ],
     ...
     * @return array<string, mixed>
     */
    public static function provideValidSuccessData(): array
    {
        return [
            'with data' => [
                'data' => [
